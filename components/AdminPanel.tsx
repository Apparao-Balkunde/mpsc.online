...
export default function App() {
  ...
  if (mode === 'ADMIN')        return <AdminPanel />;
      ...
      <div style={{ position:'relative', zIndex:10, maxWidth:680, margin:'0 auto', padding:'0 14px 20px' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10, marginBottom:20 }}>
          {[
            ...
            { emoji:'⚔️', title:'Tournament',     sub:'20Q · 15sec · Rank', color:'#D97706', bg:'rgba(217,119,6,0.07)', border:'rgba(217,119,6,0.25)', onClick:()=>go('TOURNAMENT') },
            ...
            { emoji:'🪙', title:'Coin Shop',       sub:'Themes unlock', color:'#D97706', bg:'rgba(217,119,6,0.07)', border:'rgba(217,119,6,0.2)', onClick:()=>setShowCoinShop(true) },
